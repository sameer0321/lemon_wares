...
import leftElipse from '../assets/images/left-elipse.webp'
import middleElipse from '../assets/images/middle-elipse.webp'
import rightElipse from '../assets/images/right-elipse.webp'
const Website = () => {
    return (
        <>
            <div className='px-6 overflow-hidden' data-aos="zoom-in" id='contact'>
                <div className="max-w-[1232px] relative mx-auto px-3 bg-slate-50 rounded-2xl pt-[80px] pb-[88px] my-[70px]" >
                    ...
                    <img src={middleElipse} alt="elipse" className=' absolute top-0 left-[26%]' />
                    <img src={rightElipse} alt="elipse" className=' absolute bottom-[9%] right-[-2%]' />
                    <img src={leftElipse} alt="elipse" className=' absolute bottom-[15%] left-[-1.3%]' />
                </div>
            </div>
        </>
    )
